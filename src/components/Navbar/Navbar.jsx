...
export default function Navbar() {
  ...
  return (
    <nav className='grid grid-cols-3 justify-between px-20 py-4 bg-[#87CEFA] items-center'>
      <ul className='flex justify-between'>
        <li className='flex items-center justify-center'>
          <Link to='/' className='text-[#F2F4FF] hover:text-[#565f93] active:text-[#1d2342]'>Home</Link>
        </li>
        <li className='flex items-center justify-center'>
          <Link to='/about' className='text-[#F2F4FF] hover:text-[#565f93] active:text-[#1d2342]'>About</Link>
        </li>
        <li className='flex items-center justify-center'>
          <Link to='/contact' className='text-[#F2F4FF] hover:text-[#565f93] active:text-[#1d2342]'>Contact</Link>
        </li>
        </ul>
